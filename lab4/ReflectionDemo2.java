...
public class ReflectionDemo2 {
	public static void main(String[] args)throws Exception {
		...
		//dynamic way...  old one...
		p=(Politician)Class.forName("hit.lab4.AbcPolitician").getConstructor(new Class[] {String.class,String.class}).newInstance("dynamicramu","dynamic father ramu");
		
		System.out.println("dynamic ramu...:"+p);
		//dynamic way .... new one  (they have achieved this through VARARGS
		p=(Politician)Class.forName("hit.lab4.AbcPolitician").getConstructor(String.class,String.class).newInstance("new dynamicramu","new father dynamic ramu");
